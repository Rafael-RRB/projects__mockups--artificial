  ...
  return (
    <section className='main__favorites'>
      {imageArray.map((favorite, index) => (
        <article className='favorites__image' key={`personalFavorite__${index}`} style={imageStyles[index]}>
          ...
          <a href={`/static/pages/gallery/source/${favorite.source}.webp`} className='image__download' download={true}>
            'download'
          </a>
        </article>
      ))}
